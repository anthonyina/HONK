...
- title: A short (5-8 word) summary title that MUST begin with an imperative verb (e.g. "Add", "Fix", "Build", "Replace", "Extend", "Enable", "Launch", "Test"). STRICT sentence case: only the very first word is capitalised. All other words must be lowercase EXCEPT acronyms that are written in ALL CAPS (e.g. HAWK, HONK, ETA). Wrong: "Real-Time ETA Tracking for Motorists". Right: "Add real-time ETA tracking for motorists".
